print("""Summer 2030.As a seasoned horseman on a tranquil farm, 
Your routine takes a harrowing turn when unsettling reports of a zombie virus echo through the radio. 
